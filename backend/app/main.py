...
from app.routers import invoices, promo_codes, contact, checkout_prep, documents
...
app.include_router(checkout_prep.router, prefix=f"{API_PREFIX}", tags=["Checkout Prep"])
